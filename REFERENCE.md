...
#### Functions
  ...
  * *void* **async**  ( *callable* $fn, $priority = 0, $args = null )  

  * *void* **async_schedule**  ( *callable* $fn, $forFrame = 0, $args = null )  

  * *void* **async_scheduleEach**  ( *callable* $fn, $eachFrame = 0, $args = null )  

  * *void* **async_setTimeout**  ( *callable* $fn, $seconds = 0, $args = null )  

  * *void* **async_setInterval**  ( *callable* $fn, $seconds = 0, $args = null )  
